        ...
        {isDropdownVisible && (
          <div className="absolute flex-col mx-auto mt-2 space-y-2 right-32 lg:top-10 lg:right-52 top-4">
            <button
              ...
              className="flex px-4 py-2 bg-secondary bg-opacity-30 font-poppins text-green-600 border-2 border-green-500 text-[12px] lg:text-[16px] h-[35px] lg:h-[40px] w-[100px] lg:w-[150px] rounded-md shadow-md hover:scale-105 focus:outline-none focus:ring focus:border-blue-300"
            >
              WhatsApp
            </button>
            <button
              onClick={handleEmailClick}
              className="flex px-4 py-2 bg-secondary bg-opacity-30 font-poppins mt-2 text-blue-600 border-2 border-blue-500 text-[12px] lg:text-[16px] h-[35px] lg:h-[40px] w-[100px] lg:w-[150px] rounded-md shadow-md hover:scale-105 focus:outline-none focus:ring focus:border-blue-300"
            >
              Email
            </button>
          </div>
